...
import {
  ProviderOptionsTypes,
  UserInfoTypes,
} from './services/types/provider.options.types';
...
export class BaseOAuthService {
  ...
  public constructor(
    private readonly options: ProviderOptionsTypes,
  ) {}

  protected async extractUserInfo(data: any): Promise<UserInfoTypes> {
    return {
      ...data,
  ...
  public async findUserByCode(code: string): Promise<UserInfoTypes> {
